...
export default function SymptomLogger({
  ...
  const [structuredData, setStructuredData] =
    useState<StructuredSymptom | null>(null);
  ...
  const handleStopRecording = () => {
    if (mediaRecorder && isRecording) {
      ...
      // Use the transcribed text as raw input
      if (transcribedText.trim()) {
        setRawInput(transcribedText);
      } else {
        // Fallback if no speech was detected
        setRawInput("No speech detected. Please try again or use text input.");
      }
    }
  };
  ...
  const handleSubmitInput = async () => {
    ...
    try {
      ...
      const structured: StructuredSymptom = {
        ...
        recommendations:
          "Monitor symptoms and consult healthcare provider if symptoms worsen. Note: Backend connection will be restored soon.",
        rawInput: rawInput,
      ...
      const structured: StructuredSymptom = {
        ...
        possibleRisk:
          "Backend integration in progress - consult provider for medical advice",
        recommendations:
          "Monitor symptoms. Full backend functionality coming soon.",
        rawInput: rawInput,
        inputMethod: inputMethod,
      };
          ...
          <>
            ...
            <div className="py-8">
              <div className="mb-8 text-center">
                ...
                >
                  Hi {firstName} 👋 What's going on? Describe what you're
                  feeling, when it started, and how severe it is.
                </p>
              </div>
              ...
              >
                ...
                >
                  <strong>Tip:</strong> Include details like when symptoms
                  started, what makes them better or worse, and any related
          ...
          <>
            ...
            <div className="py-8 text-center">
              ...
              {isRecording && (
                <>
                  <div
                    className="w-32 h-32 rounded-full mx-auto mb-6 flex items-center justify-center animate-pulse"
          ...
          <>
            ...
            <div className="py-6">
              <div className="mb-4">
                ...
                >
                  What are you experiencing? Include details like when it
                  started, severity, and what makes it better or worse.
                </label>
                <Textarea
                  value={rawInput}
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <div
                        ...
                        style={{
                          backgroundColor:
                            structuredData.severity >= 7
                              ? "#FF6F61"
                              : structuredData.severity >= 4
                              ? "#FFB74D"
                              : "#4CAF50",
                        }}
                      >
        ...
        {showShareOptions && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            ...
            >
              ...
              >
                Your symptom log will be sent to Dr. Sarah Johnson at City
                General Hospital.
              </p>
              <div className="flex gap-3">
                <Button
